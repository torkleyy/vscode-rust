...
interface CompilerMessageSpan {
    ...
    column_end: number;
    column_start: number;
    expansion?: CompilerMessageSpanExpansion; // I don't know what type it has
    file_name: string;
    is_primary: boolean;
    label: string;
    line_end: number;
...
interface CompilerMessage {
    ...
    code?: CompilerMessageCode; // I don't know what type it has
    level: string;
    message: string;
...
export class CommandService {
    ...
    private static parseCargoMessage(errors: RustError[], cargoMessage: CargoMessage): boolean {
